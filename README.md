...
The tool also incorporates hazardous sites as defined by the EPA's Cleanup In My Community (CIMC) program, with each site ranked with a newly developed CIMC Hazard Score on a scale of 0 to 6 (most severe) for hazard severity. \
\
